...
class SRC(commands.Cog):
	...
	async def verified(self, ctx, user: str, game: str = None):
		...
		e.set_thumbnail(
		    url="https://www.speedrun.com/themes/user/{}/image.png".format(
		        userName))
		await msg.edit(embed=e)

	@commands.group(aliases=['gm'],
	                example=["group"],
	...
	async def gamemoderatorsof(self, ctx, arg=None):
		...
		embed = discord.Embed(
		    ...
		    description=
		    "**Argument (game) not specified. Try using one of these games**",
		    color=0xec0909)
		embed.add_field(name="Minecraft (Classic)", value="mcc", inline=True)
		embed.add_field(name="Classicube", value="cc", inline=True)
		embed.add_field(name="Minecraft: New Nintendo 3DS Edition",
		                value="mc3ds",
		                inline=True)
		embed.add_field(name="Minecraft: Pocket Edition Lite",
		                value="mclite",
		                inline=True)
		embed.add_field(name="Minecraft: Education Edition",
		                value="mcee",
		                inline=True)
		embed.add_field(name="Minecraft 4K", value="mc4k", inline=True)
		embed.add_field(name="Minecraft: Pi Edition",
		                value="mcpi",
		                inline=True)
	...
	async def mcc(self, ctx):
		...
		a = discord.Embed(
		    ...
		    description=
		    "<:SuperMod:808405808793911316> ReniSR (<@577935851154046998>)\n" +
